...
`v0.4.0` 과 `v0.5.0` 범위에서는 `docs/feature-definition.md` 를 제품 기능 기준선으로 함께 관리한다.
...
- `v0.4.0` 과 `v0.5.0` 기능 티켓을 만들거나 검토할 때 `docs/feature-definition.md` 를 먼저 읽고, 티켓의 `작업 내용`, `질문/결정 기록`, `완료 기준` 에 그 경계를 반영한다.
